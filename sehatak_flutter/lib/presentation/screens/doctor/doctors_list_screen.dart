      ...
      body: Column(children: [
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            const Spacer(),
            GestureDetector(onTap: () => _showSortSheet(context), child: Row(children: [Text('ترتيب: $_sortBy', style: const TextStyle(fontSize: 11, color: AppColors.grey)), SizedBox(width: 4), const Icon(Icons.swap_vert, size: 16, color: AppColors.grey)])),
          ]),
        ),
