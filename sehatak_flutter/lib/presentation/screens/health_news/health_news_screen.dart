          ...
          return Container(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                SizedBox(height: 6),
                Row(children: [Text(n['source'], style: const TextStyle(fontSize: 9, color: AppColors.primary)), SizedBox(width: 8), Text(n['time'], style: const TextStyle(fontSize: 9, color: AppColors.grey)), const Spacer(), const Icon(Icons.share, size: 14, color: AppColors.grey), SizedBox(width: 8), const Icon(Icons.bookmark_border, size: 14, color: AppColors.grey)]),
              ])),
            ]),
          );
        },
