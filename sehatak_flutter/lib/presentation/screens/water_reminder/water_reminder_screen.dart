...
class _WaterReminderScreenState extends State<WaterReminderScreen> {
  ...
  Widget _add(String label, String emoji, int g) => GestureDetector(
    ...
    child: Column(children: [Text(emoji, style: const TextStyle(fontSize: 36)), SizedBox(height: 4), Text(label, style: const TextStyle(fontSize: 11))]),
  );
}
