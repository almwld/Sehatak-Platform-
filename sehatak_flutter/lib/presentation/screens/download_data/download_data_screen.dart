      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
            ...
            child: Row(children: [const Icon(Icons.info, color: AppColors.info), SizedBox(width: 8), const Expanded(child: Text('سيتم إرسال الملف إلى بريدك الإلكتروني خلال 24 ساعة', style: TextStyle(fontSize: 11, color: AppColors.darkGrey)))]),
          ),
          SizedBox(height: 16),
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(children: [Icon(icon, color: selected ? Colors.white : AppColors.grey, size: 28), SizedBox(height: 4), Text(label, style: TextStyle(color: selected ? Colors.white : AppColors.darkGrey, fontWeight: FontWeight.bold))]),
        ),
      ),
    );
  }
