...
class HospitalBookingScreen extends StatelessWidget {
  ...
  Widget _quickBookField(String hint, IconData icon) {
    return Container(
      ...
      child: Row(children: [Icon(icon, color: Colors.white70, size: 16), SizedBox(width: 6), Expanded(child: TextField(decoration: InputDecoration(hintText: hint, hintStyle: const TextStyle(color: Colors.white60, fontSize: 11), border: InputBorder.none), style: const TextStyle(color: Colors.white, fontSize: 11)))],),
    );
  }
}
