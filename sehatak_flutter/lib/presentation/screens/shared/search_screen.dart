...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget _cat(String t, IconData i, Color c) => Container(decoration: BoxDecoration(color: c.withOpacity(0.06), borderRadius: BorderRadius.circular(12)), child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(i, color: c, size: 20), SizedBox(width: 8), Text(t, style: TextStyle(color: c, fontWeight: FontWeight.w500))]));
}
