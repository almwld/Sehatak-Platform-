...
class _CartScreenState extends State<CartScreen> {
  ...
  final List<Map<String, dynamic>> _payments = [
    {'id': 'floosak', 'name': 'فلوسك', 'color': AppColors.primary},
    {'id': 'jawali', 'name': 'جوالي', 'color': AppColors.teal},
    {'id': 'cash', 'name': 'كاش', 'color': AppColors.warning},
  ];
                ...
                children: _payments.map((p) {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: sel ? (p['color'] as Color).withOpacity(0.1) : Colors.white,
                        borderRadius: BorderRadius.circular(16),
                        border: Border.all(
                          color: sel ? (p['color'] as Color) : AppColors.lightGrey,
                          width: 1.5,
                        ),
                      ),
                      child: Column(
                        ...
                        children: [
                          Icon(
                            Icons.payment,
                            color: sel ? (p['color'] as Color) : AppColors.darkGrey,
                          ),
