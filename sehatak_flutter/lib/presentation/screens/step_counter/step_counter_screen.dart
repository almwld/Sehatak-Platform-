    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          Container(
            ...
            child: Column(children: [
              Stack(alignment: Alignment.center, children: [
                ...
                Column(children: [const Text('🚶', style: TextStyle(fontSize: 36)), SizedBox(height: 4), Text('$_steps', style: const TextStyle(color: Colors.white, fontSize: 36, fontWeight: FontWeight.bold)), const Text('خطوة', style: TextStyle(color: Colors.white70, fontSize: 14))]),
              ]),
              SizedBox(height: 12),
          ...
          SizedBox(height: 16),
          Row(children: [_s('سعرات', '245', '🔥', AppColors.error), SizedBox(width: 10), _s('مسافة', '4.8 كم', '📍', AppColors.info), SizedBox(width: 10), _s('دقائق', '45', '⏱️', AppColors.success)]),
          SizedBox(height: 16),
