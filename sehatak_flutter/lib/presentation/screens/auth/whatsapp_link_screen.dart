  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(padding: const EdgeInsets.all(24), child: Column(children: [
        SizedBox(height: 40), const Icon(Icons.chat, color: Color(0xFF25D366), size: 80),
        SizedBox(height: 20), const Text('أدخل رقم الواتساب', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
        SizedBox(height: 20),
