    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(children: [Text(label, style: TextStyle(fontWeight: FontWeight.bold, color: selected ? color : AppColors.darkGrey)), SizedBox(height: 2), Text(time, style: TextStyle(fontSize: 9, color: selected ? color : AppColors.grey))]),
        ),
      ),
    );
  }
