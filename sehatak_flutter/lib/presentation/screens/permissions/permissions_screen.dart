  ...
  Widget _permissionCard(IconData icon, String title, String desc, bool value, bool required, Function(bool) onChange) {
    return Container(
      ...
      child: SwitchListTile(
        ...
        title: Row(children: [Text(title, style: const TextStyle(fontWeight: FontWeight.w500)), if (required) ...[SizedBox(width: 6), Container(padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2), decoration: BoxDecoration(color: AppColors.error.withOpacity(0.1), borderRadius: BorderRadius.circular(4)), child: const Text('ضروري', style: TextStyle(fontSize: 8, color: AppColors.error)))]],),
