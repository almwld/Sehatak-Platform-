      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            ...
            child: Row(children: [const Icon(Icons.play_circle, color: Colors.white, size: 48), SizedBox(width: 12), const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('تثقيف صحي', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)), Text('فيديوهات تعليمية من أطبائنا', style: TextStyle(color: Colors.white70, fontSize: 12))]))]),
          ),
          SizedBox(height: 16),
          SizedBox(
            height: 40,
          ...
          ..._videos.map((v) => Container(
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [const Icon(Icons.play_circle_fill, size: 12, color: AppColors.primary), SizedBox(width: 4), Text(v['duration'], style: const TextStyle(fontSize: 10, color: AppColors.primary)), SizedBox(width: 12), const Icon(Icons.visibility, size: 12, color: AppColors.grey), SizedBox(width: 4), Text(v['views'], style: const TextStyle(fontSize: 10, color: AppColors.grey))])],
              )),
