import 'package:sehatak_flutter/presentation/screens/cart/cart_screen.dart';
import 'package:sehatak_flutter/presentation/screens/health_map/health_map_screen.dart';
import 'package:sehatak_flutter/presentation/screens/physiotherapy/physiotherapy_screen.dart';
import 'package:sehatak_flutter/presentation/screens/family_planning/family_planning_screen.dart';
import 'package:sehatak_flutter/presentation/screens/genetic_counseling/genetic_counseling_screen.dart';
import 'package:sehatak_flutter/presentation/screens/alternative_medicine/alternative_medicine_screen.dart';
import 'package:sehatak_flutter/presentation/screens/share_app/share_app_screen.dart';
import 'package:sehatak_flutter/presentation/screens/rate_app/rate_app_screen.dart';
import 'package:sehatak_flutter/presentation/screens/help_center/help_center_screen.dart';
import 'package:sehatak_flutter/presentation/screens/contact_us/contact_us_screen.dart';
import 'package:sehatak_flutter/presentation/screens/report_issue/report_issue_screen.dart';
...
import 'package:sehatak_flutter/presentation/screens/permissions/permissions_screen.dart';
import 'package:sehatak_flutter/presentation/screens/download_data/download_data_screen.dart';
import 'package:sehatak_flutter/presentation/screens/font_size/font_size_screen.dart';
import 'package:sehatak_flutter/presentation/screens/two_factor_auth/two_factor_auth_screen.dart';
import 'package:sehatak_flutter/presentation/screens/change_password/change_password_screen.dart';
import 'package:sehatak_flutter/presentation/screens/edit_profile/edit_profile_screen.dart';
import 'package:sehatak_flutter/presentation/screens/risk_calculator/risk_calculator_screen.dart';
import 'package:sehatak_flutter/presentation/screens/diet_plan/diet_plan_screen.dart';
import 'package:sehatak_flutter/presentation/screens/checkup_reminder/checkup_reminder_screen.dart';
import 'package:sehatak_flutter/presentation/screens/recovery_calculator/recovery_calculator_screen.dart';
import 'package:sehatak_flutter/presentation/screens/home_lab/home_lab_screen.dart';
import 'package:sehatak_flutter/presentation/screens/personal_medic/personal_medic_screen.dart';
import 'package:sehatak_flutter/presentation/screens/shopping_list/shopping_list_screen.dart';
import 'package:sehatak_flutter/presentation/screens/pill_organizer/pill_organizer_screen.dart';
import 'package:sehatak_flutter/presentation/screens/urgent_consult/urgent_consult_screen.dart';
import 'package:sehatak_flutter/presentation/screens/drug_compare/drug_compare_screen.dart';
import 'package:sehatak_flutter/presentation/screens/pediatric_dose/pediatric_dose_screen.dart';
import 'package:sehatak_flutter/presentation/screens/vision_test/vision_test_screen.dart';
import 'package:sehatak_flutter/presentation/screens/weather_health/weather_health_screen.dart';
import 'package:sehatak_flutter/presentation/screens/health_education/health_education_screen.dart';
import 'package:sehatak_flutter/presentation/screens/share_health/share_health_screen.dart';
import 'package:sehatak_flutter/presentation/screens/health_news/health_news_screen.dart';
import 'package:sehatak_flutter/presentation/screens/nearby_clinics/nearby_clinics_screen.dart';
import 'package:sehatak_flutter/presentation/screens/vitals/vitals_dashboard_screen.dart';
import 'package:sehatak_flutter/presentation/screens/health_calendar/health_calendar_screen.dart';
import 'package:sehatak_flutter/presentation/screens/shared/search_screen.dart';
...
import 'package:sehatak_flutter/presentation/screens/shared/notifications_screen.dart';
import 'package:sehatak_flutter/presentation/screens/settings/settings_screen.dart';
import 'package:sehatak_flutter/presentation/screens/emergencies/emergency_numbers.dart';
import 'package:sehatak_flutter/presentation/screens/insurance/insurance_companies.dart';
import 'package:sehatak_flutter/presentation/screens/lab/labs_list_screen.dart';
import 'package:sehatak_flutter/presentation/screens/map/interactive_map_screen.dart';
import 'package:sehatak_flutter/presentation/screens/about/about_screen.dart';
import 'package:sehatak_flutter/presentation/screens/health_tips/health_tips_screen.dart';
import 'package:sehatak_flutter/presentation/screens/women_health/period_tracker_screen.dart';
import 'package:sehatak_flutter/presentation/screens/home_care/home_care_screen.dart';
import 'package:sehatak_flutter/presentation/screens/family_doctor/family_doctor_screen.dart';
import 'package:sehatak_flutter/presentation/screens/blood_donation/blood_donation_screen.dart';
...
import 'package:sehatak_flutter/presentation/screens/child_growth/child_growth_screen.dart';
import 'package:sehatak_flutter/presentation/screens/drug_dictionary/drug_dictionary_screen.dart';
...
import 'package:sehatak_flutter/presentation/screens/health_tools/calorie_calculator_screen.dart';
import 'package:sehatak_flutter/presentation/screens/mental_health/mental_health_screen.dart';
import 'package:sehatak_flutter/presentation/screens/articles/articles_screen.dart';
import 'package:sehatak_flutter/presentation/screens/health_shop/health_shop_screen.dart';
import 'package:sehatak_flutter/presentation/screens/hospital_booking/hospital_booking_screen.dart';
import 'package:sehatak_flutter/presentation/screens/pregnancy/pregnancy_tracker_screen.dart';
import 'package:sehatak_flutter/presentation/screens/symptom_checker/symptom_checker_screen.dart';
...
import 'package:sehatak_flutter/presentation/screens/health_challenges/health_challenges_screen.dart';
import 'package:sehatak_flutter/presentation/screens/glucose_tracker/glucose_tracker_screen.dart';
import 'package:sehatak_flutter/presentation/screens/stress_meter/stress_meter_screen.dart';
import 'package:sehatak_flutter/presentation/screens/dental_care/dental_care_screen.dart';
import 'package:sehatak_flutter/presentation/screens/smart_clinic/smart_clinic_screen.dart';
import 'package:sehatak_flutter/presentation/screens/eye_care/eye_care_screen.dart';
import 'package:sehatak_flutter/presentation/screens/medication/advanced_reminder_screen.dart';
import 'package:sehatak_flutter/presentation/screens/health_community/health_community_screen.dart';
...
import 'package:sehatak_flutter/presentation/screens/favorites/favorite_doctors_screen.dart';
import 'package:sehatak_flutter/presentation/screens/voice_search/voice_search_screen.dart';
import 'package:sehatak_flutter/presentation/screens/video_consult/video_consult_screen.dart';
import 'package:sehatak_flutter/presentation/screens/visit_history/visit_history_screen.dart';
import 'package:sehatak_flutter/presentation/screens/hospital_compare/hospital_compare_screen.dart';
import 'package:sehatak_flutter/presentation/screens/medical_notes/medical_notes_screen.dart';
