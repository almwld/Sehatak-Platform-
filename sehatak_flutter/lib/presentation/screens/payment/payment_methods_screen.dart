...
class _PaymentMethodsScreenState extends State<PaymentMethodsScreen> {
  ...
  Widget _btn(String l, IconData i, VoidCallback t) => GestureDetector(onTap: t, child: Column(children: [Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), shape: BoxShape.circle), child: Icon(i, color: Colors.white, size: 22)), SizedBox(height: 4), Text(l, style: const TextStyle(color: Colors.white, fontSize: 10))]));
}
